...
import kotlinx.android.synthetic.main.fragement_chats.*
...
//    lateinit var mAdapter:FirestorePagingAdapter<User, UserViewHolder>
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        setupAdapter()
        return inflater.inflate(R.layout.fragement_chats, container, false)
    }

    private fun setupAdapter() {
        val config = PagedList.Config.Builder()
            .setEnablePlaceholders(false) // no nulls
